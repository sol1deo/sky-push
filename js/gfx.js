...
SKY.GFX = (function () {
  ...
  // rusty oil-rig scrap (Kenney Survival Kit), abandoned graveyard set
  // (Kenney Graveyard Kit) and a full space theme (Kenney Space Kit) —
  // all CC0, same generic pack loader
  const GRAVE_NAMES = ['altar-stone','altar-wood','bench','bench-damaged','border-pillar','brick-wall','brick-wall-curve','brick-wall-curve-small','brick-wall-end','candle','candle-multiple','character-ghost','character-keeper','character-skeleton','character-vampire','character-zombie','coffin','coffin-old','column-large','cross','cross-column','cross-wood','crypt','crypt-a','crypt-b','crypt-door','crypt-large','crypt-large-door','crypt-large-roof','crypt-small','crypt-small-roof','debris','debris-wood','detail-bowl','detail-chalice','detail-plate','fence','fence-damaged','fence-gate','fire-basket','grave','grave-border','gravestone-bevel','gravestone-broken','gravestone-cross','gravestone-cross-large','gravestone-debris','gravestone-decorative','gravestone-roof','gravestone-round','gravestone-wide','hay-bale','hay-bale-bundled','iron-fence','iron-fence-bar','iron-fence-border','iron-fence-border-column','iron-fence-border-curve','iron-fence-border-gate','iron-fence-curve','iron-fence-damaged','lantern-candle','lantern-glass','lightpost-all','lightpost-double','lightpost-single','pillar-large','pillar-obelisk','pillar-small','pillar-square','pine','pine-crooked','pine-fall','pine-fall-crooked','pumpkin','pumpkin-carved','pumpkin-tall','pumpkin-tall-carved','road','rocks','rocks-tall','shovel','shovel-dirt','stone-wall','stone-wall-column','stone-wall-curve','stone-wall-damaged','trunk','trunk-long','urn-round','urn-square'];
  const SPACE_NAMES = ['alien','astronautA','astronautB','barrel','barrels','barrels_rail','bones','chimney','chimney_detailed','corridor','corridor_corner','corridor_cornerRound','corridor_cornerRoundWindow','corridor_cross','corridor_detailed','corridor_end','corridor_open','corridor_roof','corridor_split','corridor_wall','corridor_wallCorner','corridor_window','corridor_windowClosed','craft_cargoA','craft_cargoB','craft_miner','craft_racer','craft_speederA','craft_speederB','craft_speederC','craft_speederD','crater','craterLarge','desk_chair','desk_chairArms','desk_chairStool','desk_computer','desk_computerCorner','desk_computerScreen','gate_complex','gate_simple','hangar_largeA','hangar_largeB','hangar_roundA','hangar_roundB','hangar_roundGlass','hangar_smallA','hangar_smallB','machine_barrel','machine_barrelLarge','machine_generator','machine_generatorLarge','machine_wireless','machine_wirelessCable','meteor','meteor_detailed','meteor_half','monorail_trackCornerLarge','monorail_trackCornerSmall','monorail_trackSlope','monorail_trackStraight','monorail_trackSupport','monorail_trackSupportCorner','monorail_trainBox','monorail_trainCargo','monorail_trainEnd','monorail_trainFlat','monorail_trainFront','monorail_trainPassenger','pipe_corner','pipe_cornerDiagonal','pipe_cornerRound','pipe_cornerRoundLarge','pipe_cross','pipe_end','pipe_entrance','pipe_open','pipe_rampLarge','pipe_rampSmall','pipe_ring','pipe_ringHigh','pipe_ringHighEnd','pipe_ringSupport','pipe_split','pipe_straight','pipe_supportHigh','pipe_supportLow','platform_center','platform_corner','platform_cornerOpen','platform_cornerRound','platform_end','platform_high','platform_large','platform_long','platform_low','platform_side','platform_small','platform_smallDiagonal','platform_straight','rail','rail_corner','rail_end','rail_middle','rock','rock_crystals','rock_crystalsLargeA','rock_crystalsLargeB','rock_largeA','rock_largeB','rocket_baseA','rocket_baseB','rocket_finsA','rocket_finsB','rocket_fuelA','rocket_fuelB','rocket_sidesA','rocket_sidesB','rocket_topA','rocket_topB','rocks_smallA','rocks_smallB','rover','satelliteDish','satelliteDish_detailed','satelliteDish_large','stairs','stairs_corner','stairs_short','structure','structure_closed','structure_detailed','structure_diagonal','supports_high','supports_low','terrain','terrain_ramp','terrain_rampLarge','terrain_rampLarge_detailed','terrain_roadCorner','terrain_roadCross','terrain_roadEnd','terrain_roadSplit','terrain_roadStraight','terrain_side','terrain_sideCliff','terrain_sideCorner','terrain_sideCornerInner','terrain_sideEnd','turret_double','turret_single','weapon_gun','weapon_rifle'];
  const SURVIVAL_NAMES = ['barrel','barrel-open','bedroll','bedroll-frame','bedroll-packed','bottle','bottle-large','box','box-large','box-large-open','box-open','bucket','campfire-fishing-stand','campfire-pit','campfire-stand','chest','fence','fence-doorway','fence-fortified','fish','fish-large','floor','floor-hole','floor-old','grass','grass-large','metal-panel','metal-panel-narrow','metal-panel-screws','metal-panel-screws-half','metal-panel-screws-narrow','patch-grass','patch-grass-large','resource-planks','resource-stone','resource-stone-large','resource-wood','rock-a','rock-b','rock-c','rock-flat','rock-flat-grass','rock-sand-a','rock-sand-b','rock-sand-c','signpost','signpost-single','structure','structure-canvas','structure-floor','structure-metal','structure-metal-doorway','structure-metal-floor','structure-metal-roof','structure-metal-wall','structure-roof','tent','tent-canvas','tent-canvas-half','tool-axe','tool-axe-upgraded','tool-hammer','tool-hammer-upgraded','tool-hoe','tool-hoe-upgraded','tool-pickaxe','tool-pickaxe-upgraded','tool-shovel','tool-shovel-upgraded','tree','tree-autumn','tree-autumn-tall','tree-autumn-trunk','tree-log','tree-log-small','tree-tall','tree-trunk','workbench','workbench-anvil','workbench-grind'];
  const EXTRA_PACKS = [
    ...
    { dir: 'survival', prefix: 'srv-', names: SURVIVAL_NAMES, folder: 'oil rig & scrap', scale: 4, lambert: true },
    { dir: 'grave', prefix: 'gy-', names: GRAVE_NAMES, folder: 'abandoned & spooky', scale: 4, lambert: true },
    { dir: 'space', prefix: 'sp-', names: SPACE_NAMES, folder: 'space', scale: 4, lambert: true },
