...
SKY.TUNING = {
  ...
  weapons: {
    ...
    quad: {
      ...
      headshotMult: 1.0, upFactor: 0.3, maxKnockback: 26, selfRecoil: 3, kick: 1.8, kickPitch: 0.026,
    },
    piston: {
      label: 'PISTON CANNON', short: 'PISTON', icon: '🔩', rarity: 'rare', color: '#ff8560',
      desc: 'Hold to compress. Release to launch someone.',
      cooldown: 0.55, auto: false, mag: 5, reloadTime: 2.0, range: 90,
      projSpeed: 46, projGravity: 1, charge: 1.1, chargeMult: 3.0,
      pellets: 1, spreadDeg: 0.6, zoomSpreadDeg: 0.3, zoomFov: 66,
      baseKnockback: 5.5, speedMult: 0.7, airborneBonus: 1.3, slideBonus: 1.3,
      headshotMult: 1.8, upFactor: 0.32, maxKnockback: 46, selfRecoil: 1.2, kick: 1.4, kickPitch: 0.020,
    },
  },
